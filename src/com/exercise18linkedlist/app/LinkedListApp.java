...
public class LinkedListApp 
{
	...
	public static void main(String[] args) 
	{
		...
		//EN ocasiones no sabes que vas a recibir un objeto y utilizas un poliformismo 
		//Generics en Java
		//El warning sale porque no indentifica el tipo de datos y s eponen <> 
